// Package logger provides the application-wide slog setup and a Fiber
// middleware that creates a request-scoped logger (with request ID and
// request attributes) and carries it in the request context. Any layer with a
// ctx — handler, service, or repository — retrieves it with FromContext and
// its log lines carry the same request ID.
package logger
...
// for tests of the middleware; handlers and services should use FromContext.
