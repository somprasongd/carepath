...
| ผู้ป่วย | LINE OA → LIFF | ดูเส้นทางทั้งวัน, ดูขั้นตอนถัดไป, นำทางไปจุดบริการ (เลือกชั้นได้บนเส้นทางข้ามชั้น), สแกน QR หรือเลือกจุดเพื่อระบุตำแหน่ง, เห็นสถานะใหม่อัตโนมัติเมื่อเจ้าหน้าที่ปิดขั้นตอน | ใช้งานได้จริง |
...
| ญาติผู้ป่วย | ลิงก์จำกัดเวลา | ติดตามว่าผู้ป่วยอยู่ขั้นตอนไหน | ใช้งานได้จริง — ปุ่ม "แชร์ความคืบหน้าให้ญาติ" บนหน้าเส้นทางของผู้ป่วย และหน้า `/shared` อัปเดตทุก 15 วินาที ([ADR-0011](docs/adr/0011-visit-share-link.md)) |
...
> **ใช้งานได้จริง (#89 + #90)** — สาม endpoint ตาม [ADR-0011](docs/adr/0011-visit-share-link.md) · ผู้ป่วยกด "แชร์ความคืบหน้าให้ญาติ" (ปุ่มรอง ไม่แตะปุ่มส้ม "นำทาง" ที่มีใบเดียวบนหน้าจอ) บนหน้าเส้นทาง แล้ว copy ลิงก์ `/shared#<token>` ส่งทาง LINE ได้เลย · หน้า `/shared` ของญาติอัปเดตอัตโนมัติทุก 15 วินาที และบอกชัดเจนเมื่อลิงก์หมดอายุหรือถูกถอน
...
| ระบุตำแหน่งด้วย QR | ✅ ใช้งานได้ — สแกนจากหน้านำทาง + สติกเกอร์ QR จากคอนโซลเจ้าหน้าที่ (จุดบริการและจุดอ้างอิง เช่น ลิฟต์) |
...
| ลิงก์ติดตามให้ญาติ | ✅ ใช้งานได้ ([ADR-0011](docs/adr/0011-visit-share-link.md)) |
