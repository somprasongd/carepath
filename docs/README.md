...
- [Presentation Outline — Hospital/Stakeholder Review](deliverables/presentation-outline-hospital-review.md) — separate script for the HIS-integration/executive-dashboard presentation round, not the hackathon brief's numbered deliverables; slide deck at `presentation-outline-hospital-review.pptx`, full Thai speaking script at [presentation-script-hospital-review.md](deliverables/presentation-script-hospital-review.md)
