...
There are currently no automated tests or CI pipeline in this repo — treat adding them as high-priority groundwork before relying on tooling to verify correctness. See `docs/process/ai-native-sdlc-workflow.md` for the plan to close this gap.
